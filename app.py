...
Swagger(app, template_file="src/swagger/global_template.yml")

# 1. Obtener todos los usuarios (Carlos, Ana, Luis...)
@app.route("/usuarios", methods=['GET'])
@swag_from("src/swagger/get_usuarios.yml")
def get_usuarios():
...
@swag_from("src/swagger/get_usuarios_id.yml")
...
@swag_from("src/swagger/post_usuarios.yml")
def new_usuario():
...
@swag_from("src/swagger/put_usuarios.yml")
...
@swag_from("src/swagger/delete_usuarios.yml")
...
@swag_from("src/swagger/patch_usuarios.yml")
